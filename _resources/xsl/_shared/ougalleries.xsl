...
-->
	...
	<xsl:function name="ou:gallery-headcode">
		...
		<xsl:choose>
			<xsl:when test="$gallery-type = 'flex'">
				<link rel="stylesheet" href="/_resources/ldp/galleries/flex-slider/flexslider.css" type="text/css"/>
				<link rel="stylesheet" href="/_resources/ldp/galleries/flex-slider/flex-caption.css" type="text/css"/>
			</xsl:when>
			<xsl:when test="$gallery-type = 'pretty'">			
				<link rel="stylesheet" href="/_resources/ldp/galleries/bootstrap-thumbnails.css"/> 			
				<link rel="stylesheet" href="/_resources/ldp/galleries/pretty-photo/prettyPhoto.css" type="text/css" media="screen" title="prettyPhoto main stylesheet" charset="utf-8" />
			</xsl:when>
		</xsl:choose>
	</xsl:function>
	<!--
