...
<xsl:stylesheet version="3.0" 
	...
	<xsl:template name="calendar-headcode">
		<xsl:if test="descendant::calendar|descendant::calendar-only|descendant::calendar-events-only"><link rel="stylesheet" href="/_resources/js/calendar/calendar.css" /></xsl:if>
	</xsl:template>
